...
```{=html}
<iframe src="https://lambdadesworkshopslides-qq8afijruasph6hkyqgvuq.streamlit.app/?embed_options=dark_theme" style="height: 650px; width: 100%;"></iframe>
```

## Another

<iframe class="stretch" data-src="https://lambdadesworkshopslides-qq8afijruasph6hkyqgvuq.streamlit.app/?embed_options=dark_theme"></iframe>


## And Another

<iframe class="stretch" src="https://pythonhealthdatascience.github.io/stars-reproduce-kim-2021/evaluation/reproduction_report.html"></iframe>
...
```{r}
#| echo: false
knitr::include_url({"https://lambdadesworkshopslides-qq8afijruasph6hkyqgvuq.streamlit.app/?embed_options=dark_theme"})
```
...
## A more complex fully contained example
