...
class g:
    ...
    leaving_reasons = [
        "Oh no,<br> it's full",
        "I drove<br>miles to<br>get here",
        "That was<br>a wasted<br>journey",
        "I'm going<br>to<br>complain",
        "I can't<br>get here<br>any other<br>day",
        "What a<br>stupid system",
        "I'm<br>tweeting<br>about this",
        "What do<br>I do<br>now?"
    ]
...
event_position_df = create_event_position_df([
    ...
    EventPosition(event="baulking", x=250 , y=225 , label=" "),
